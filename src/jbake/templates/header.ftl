...
<html lang="ru">
  <head>
    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Comfortaa:400,700|Roboto:400,700&amp;subset=cyrillic" />
    ...
    <link rel="stylesheet" href="<#if (content.rootpath)??>${content.rootpath}<#else></#if>css/highlight/monokai-sublime.css">
