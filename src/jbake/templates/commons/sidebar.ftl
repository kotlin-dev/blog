...
<section id="sidebar">
				...
				<#if (published_posts?size > config.sidebar_postAmount?number) >
                    <li>
                        <ul class="actions">
                            ...
                            class="button">Показать больше записей</a></li>
                        </ul>
                    </li>
                </#if>
            </ul>
    ...
    <!-- About -->
    <#if (config.sidebar_intro_about_show?boolean == true) >
        <section class="blurb">
            <h2>О сайте</h2>
            <p>${config.sidebar_intro_about}</p>

            <ul class="actions">
                <li><a href="${content.rootpath}${config.sidebar_intro_about_learnMore}" class="button">Узнать больше</a></li>
            </ul>
        </section>
    </#if>
        <section id="footer">
